 ...
 * License: MIT
 */
!function(global,factory){"object"==typeof exports&&"undefined"!=typeof module?factory(exports):"function"==typeof define&&define.amd?define(["exports"],factory):factory((global.ng=global.ng||{},global.ng.animations=global.ng.animations||{}))}(this,function(exports){"use strict";function trigger(name,definitions){return{type:7,name:name,definitions:definitions}}function animate(timings,styles){return void 0===styles&&(styles=null),{type:4,styles:styles,timings:timings}}function group(steps,locals){return void 0===locals&&(locals=null),{type:3,steps:steps,locals:locals}}function sequence(steps,locals){return void 0===locals&&(locals=null),{type:2,steps:steps,locals:locals}}function style(tokens){return{type:6,styles:tokens,offset:null}}function state(name,styles){return{type:0,name:name,styles:styles}}function keyframes(steps){return{type:5,steps:steps}}function transition(stateChangeExpr,steps,locals){return void 0===locals&&(locals=null),{type:1,expr:stateChangeExpr,animation:steps,locals:locals}}function animation(steps,locals){return void 0===locals&&(locals=null),{type:8,animation:steps,locals:locals}}function animateChild(locals){return void 0===locals&&(locals=null),{type:9,locals:locals}}function useAnimation(animation,locals){return void 0===locals&&(locals=null),{type:10,animation:animation,locals:locals}}function query(selector,animation,locals){return void 0===locals&&(locals=null),{type:11,multi:!1,selector:selector,animation:animation,locals:locals}}function queryAll(selector,animation,locals){return void 0===locals&&(locals=null),{type:11,multi:!0,selector:selector,animation:animation,locals:locals}}function stagger(timings,animation){return{type:12,timings:timings,animation:animation}}/**
 * @license
