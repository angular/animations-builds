 ...
 * License: MIT
 */
!function(global,factory){"object"==typeof exports&&"undefined"!=typeof module?factory(exports):"function"==typeof define&&define.amd?define(["exports"],factory):factory((global.ng=global.ng||{},global.ng.animations=global.ng.animations||{}))}(this,function(exports){"use strict";function trigger(name,definitions){return{type:0,name:name,definitions:definitions}}function animate(timings,styles){return void 0===styles&&(styles=null),{type:5,styles:styles,timings:timings}}function group(steps){return{type:4,steps:steps}}function sequence(steps){return{type:3,steps:steps}}function style(tokens){return{type:7,styles:tokens}}function state(name,styles){return{type:1,name:name,styles:styles}}function keyframes(steps){return{type:6,steps:steps}}function transition(stateChangeExpr,steps,locals){return void 0===locals&&(locals=null),{type:2,expr:stateChangeExpr,animation:steps,locals:locals}}function animation(steps,locals){return void 0===locals&&(locals=null),{type:8,animation:steps,locals:locals}}function animateChild(){for(var args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];return{type:9,args:args}}function query(selector,animation){return{type:10,multi:!1,selector:selector,animation:animation}}function queryAll(selector,animation){return{type:10,multi:!0,selector:selector,animation:animation}}function stagger(){for(var args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];return{type:11,args:args}}function wait(delay,animation){return{type:12,delay:delay,animation:animation}}/**
 * @license
