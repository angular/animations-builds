(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define('@angular/animation', ['exports', '@angular/core'], factory);
        ...
        global.ng = global.ng || {};
        global.ng.animation = mod.exports;
    }
    ...
    exports.ɵf = exports.ɵc = exports.ɵe = exports.ɵd = exports.ɵa = exports.trigger = exports.AnimationTrigger = exports.transition = exports.style = exports.state = exports.sequence = exports.keyframes = exports.group = exports.animate = exports.AUTO_STYLE = exports.Animation = exports.AnimationModule = undefined;
    ...
    var AnimationDriver = function () {
        ...
        _createClass(AnimationDriver, [{
            key: 'animate',
            value: function animate(element, keyframes, duration, delay, easing, previousPlayers) {}
        }]);
    ...
    var DomAnimationTransitionEngine = function (_TransitionEngine) {
        _inherits(DomAnimationTransitionEngine, _TransitionEngine);
        ...
        function DomAnimationTransitionEngine(_driver, _normalizer) {
            _classCallCheck(this, DomAnimationTransitionEngine);

            var _this2 = _possibleConstructorReturn(this, (DomAnimationTransitionEngine.__proto__ || Object.getPrototypeOf(DomAnimationTransitionEngine)).call(this));

            _this2._driver = _driver;
            _this2._normalizer = _normalizer;
            _this2._flaggedInserts = new Set();
            _this2._queuedRemovals = [];
            _this2._queuedAnimations = [];
            _this2._activeElementAnimations = new Map();
            _this2._activeTransitionAnimations = new Map();
            return _this2;
        }
        /**
         * @param {?} container
        ...
        _createClass(DomAnimationTransitionEngine, [{
            key: 'insertNode',
            ...
            value: function removeNode(element) {
                this._queuedRemovals.push(element);
            }
        }, {
            key: 'process',
            value: function process(element, instructions) {
                var _this3 = this;

                var /** @type {?} */players = instructions.map(function (instruction) {
                    if (instruction.type == 0 /* TransitionAnimation */) {
                            return _this3._handleTransitionAnimation(element, /** @type {?} */instruction);
                        }
                    if (instruction.type == 1 /* TimelineAnimation */) {
                            return _this3._handleTimelineAnimation(element, /** @type {?} */instruction, []);
                        }
                    return new _core.ɵNoOpAnimationPlayer();
                });
            ...
            key: '_handleTransitionAnimation',
            value: function _handleTransitionAnimation(element, instruction) {
                var _this4 = this;
                ...
                var /** @type {?} */players = instruction.timelines.map(function (timelineInstruction) {
                    return _this4._buildPlayer(element, timelineInstruction, previousPlayers);
                });
                ...
                player.onDone(function () {
                    player.destroy();
                    var /** @type {?} */elmTransitionMap = _this4._activeTransitionAnimations.get(element);
                    if (elmTransitionMap) {
                        delete elmTransitionMap[triggerName];
                        if (Object.keys(elmTransitionMap).length == 0) {
                            _this4._activeTransitionAnimations.delete(element);
                        }
                    }
                    deleteFromArrayMap(_this4._activeElementAnimations, element, player);
            ...
            key: '_handleTimelineAnimation',
            value: function _handleTimelineAnimation(element, instruction, previousPlayers) {
                var _this5 = this;

                var /** @type {?} */player = this._buildPlayer(element, instruction, previousPlayers);
                player.onDestroy(function () {
                    deleteFromArrayMap(_this5._activeElementAnimations, element, player);
                });
                this._queuePlayer(element, player);
                return player;
            }
            ...
            value: function _normalizeKeyframes(keyframes) {
                ...
                keyframes.forEach(function (kf) {
                    ...
                    Object.keys(kf).forEach(function (prop) {
                        ...
                        if (prop != 'offset') {
                            normalizedProp = _this6._normalizer.normalizePropertyName(prop, errors);
                            normalizedValue = _this6._normalizer.normalizeStyleValue(prop, normalizedProp, kf[prop], errors);
                        }
            ...
            key: '_queuePlayer',
            value: function _queuePlayer(element, player) {
            ...
            value: function triggerAnimations() {
                ...
                while (this._queuedAnimations.length) {
                    var _queuedAnimations$shi = this._queuedAnimations.shift(),
                        player = _queuedAnimations$shi.player,
                        element = _queuedAnimations$shi.element;
                ...
                this._queuedRemovals.forEach(function (element) {
                    if (_this7._flaggedInserts.has(element)) return;
                    var /** @type {?} */parent = element;
                    var /** @type {?} */players = void 0;
                    while (parent = parent.parentNode) {
                        var /** @type {?} */match = _this7._activeElementAnimations.get(parent);
                        if (match) {
                            players = match;
                            break;
                        }
    ...
    }(_core.ɵTransitionEngine);

    DomAnimationTransitionEngine.decorators = [{ type: _core.Injectable }];
    /** @nocollapse */
    DomAnimationTransitionEngine.ctorParameters = function () {
    ...
    function optimizeGroupPlayer(players) {
        return players.length == 1 ? players[0] : new _core.ɵAnimationGroupPlayer(players);
    }
    /**
     * @param {?} source
     * @return {?}
    ...
    var WebAnimationsPlayer = function () {
        ...
        function WebAnimationsPlayer(element, keyframes, options) {
            ...
            previousPlayers.forEach(function (player) {
                ...
                Object.keys(styles).forEach(function (prop) {
                    return _this8.previousStyles[prop] = styles[prop];
                });
            });
        }
        /**
            ...
            value: function init() {
                ...
                var /** @type {?} */keyframes = this.keyframes.map(function (styles) {
                    ...
                    Object.keys(styles).forEach(function (prop, index) {
                        ...
                        if (value == _core.AUTO_STYLE) {
                            value = _computeStyle(_this9.element, prop);
                        }
                        if (value != undefined) {
                ...
                if (previousStyleProps.length) {
                    ...
                    previousStyleProps.forEach(function (prop) {
                        ...
                        startingKeyframe[prop] = _this9.previousStyles[prop];
                    });
                    if (missingStyleProps.length) {
                        var i;

                        (function () {
                            var /** @type {?} */self = _this9;
            ...
            value: function _captureStyles() {
                ...
                if (this.hasStarted()) {
                    Object.keys(this._finalKeyframe).forEach(function (prop) {
                        if (prop != 'offset') {
                            styles[prop] = _this10._finished ? _this10._finalKeyframe[prop] : _computeStyle(_this10.element, prop);
                        }
                    });
                }
                return styles;
    ...
    AnimationModule.decorators = [{ type: _core.NgModule, args: [{
            providers: [{ provide: AnimationDriver, useFactory: resolveDefaultAnimationDriver }, { provide: AnimationStyleNormalizer, useClass: WebAnimationsStyleNormalizer }, { provide: _core.ɵTransitionEngine, useClass: DomAnimationTransitionEngine }]
        }] }];
    /** @nocollapse */
    AnimationModule.ctorParameters = function () {
        return [];
    };
    ...
    function normalizeStyles(styles) {
        ...
        styles.styles.forEach(function (styleMap) {
            return copyStyles(styleMap, false, normalizedStyles);
        });
        ...
        _createClass(AnimationTimelineVisitor, [{
            ...
            value: function visitSequence(ast, context) {
                ...
                ast.steps.forEach(function (s) {
                    return visitAnimationNode(_this11, s, context);
                });
            ...
            value: function visitGroup(ast, context) {
                ...
                ast.steps.forEach(function (s) {
                    ...
                    visitAnimationNode(_this12, s, innerContext);
            ...
            value: function visitStyle(ast, context) {
                ...
                var /** @type {?} */normalizedStyles = normalizeStyles(new _core.AnimationStyles(ast.styles));
            ...
            value: function visitKeyframeSequence(ast, context) {
                ...
                ast.steps.forEach(function (step, i) {
                    var /** @type {?} */normalizedStyles = normalizeStyles(new _core.AnimationStyles(step.styles));
        ...
        _createClass(TimelineBuilder, [{
            ...
            value: function setStyles(styles) {
                ...
                Object.keys(styles).forEach(function (prop) {
                    if (prop !== 'offset') {
                        ...
                        _this13._currentKeyframe[prop] = val;
                        if (prop !== 'easing' && !_this13._localTimelineStyles[prop]) {
                            _this13._backFill[prop] = _this13._globalTimelineStyles[prop] || AUTO_STYLE$1;
                        }
                        _this13._updateStyle(prop, val);
                    }
                });
                Object.keys(this._localTimelineStyles).forEach(function (prop) {
                    if (!_this13._currentKeyframe.hasOwnProperty(prop)) {
                        _this13._currentKeyframe[prop] = _this13._localTimelineStyles[prop];
                    }
                });
            }
        }, {
            ...
            value: function mergeTimelineCollectedStyles(timeline) {
                ...
                Object.keys(timeline._styleSummary).forEach(function (prop) {
                    var /** @type {?} */details0 = _this14._styleSummary[prop];
        ...
        _createClass(AnimationValidatorVisitor, [{
            ...
            value: function visitSequence(ast, context) {
                ...
                ast.steps.forEach(function (step) {
                    return visitAnimationNode(_this16, step, context);
                });
            }
        }, {
            key: 'visitGroup',
            value: function visitGroup(ast, context) {
                ...
                ast.steps.forEach(function (step) {
                    ...
                    visitAnimationNode(_this17, step, context);
            ...
            key: 'visitStyle',
            value: function visitStyle(ast, context) {
                var /** @type {?} */styleData = normalizeStyles(new _core.AnimationStyles(ast.styles));
            ...
            value: function visitKeyframeSequence(ast, context) {
                ...
                ast.steps.forEach(function (step) {
                    var /** @type {?} */styleData = normalizeStyles(new _core.AnimationStyles(step.styles));
                    var /** @type {?} */offset = 0;
                ...
                ast.steps.forEach(function (step, i) {
                    ...
                    _this18.visitStyle(step, context);
                });
            }
        }]);
    ...
    var Animation = function () {
        ...
        _createClass(Animation, [{
            ...
            value: function buildTimelines(startingStyles, destinationStyles) {
                var /** @type {?} */start = Array.isArray(startingStyles) ? normalizeStyles(new _core.AnimationStyles( /** @type {?} */startingStyles)) : startingStyles;
                var /** @type {?} */dest = Array.isArray(destinationStyles) ? normalizeStyles(new _core.AnimationStyles( /** @type {?} */destinationStyles)) : destinationStyles;
    ...
    var AnimationTrigger = function () {
        ...
        function AnimationTrigger(name, states, _transitionAsts) {
            ...
            Object.keys(states).forEach(function (stateName) {
                _this19.states[stateName] = copyStyles(states[stateName], false);
            });
            var errors = [];
            _transitionAsts.forEach(function (ast) {
                ...
                if (sequenceErrors.length) {
                    ...
                    _this19.transitionFactories.push(new AnimationTransitionFactory(_this19.name, ast, exprs, states));
                }
            });
            if (errors.length) {
                var LINE_START = '\n - ';
        ...
        _createClass(AnimationTriggerVisitor, [{
            ...
            value: function buildTrigger(name, definitions) {
                ...
                definitions.forEach(function (def) {
                    return visitAnimationNode(_this20, def, context);
                });
            ...
            key: 'visitState',
            value: function visitState(ast, context) {
                context.states[ast.name] = normalizeStyles(new _core.AnimationStyles(ast.styles.styles));
            }
        }, {
            key: 'visitTransition',
            value: function visitTransition(ast, context) {
    ...
    exports.ɵf = DomAnimationTransitionEngine;
});
