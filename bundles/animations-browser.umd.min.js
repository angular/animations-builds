 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */e.AnimationDriver=O,e.ɵAnimation=ge,e.ɵAnimationStyleNormalizer=_e,e.ɵNoopAnimationStyleNormalizer=Se,e.ɵWebAnimationsStyleNormalizer=Ee,e.ɵAnimationDriver=O,e.ɵNoopAnimationDriver=N,e.ɵAnimationEngine=Ze,e.ɵCssKeyframesDriver=ct,e.ɵCssKeyframesPlayer=ut,e.ɵcontainsElement=P,e.ɵinvokeQuery=k,e.ɵmatchesElement=w,e.ɵvalidateStyleProperty=b,e.ɵWebAnimationsDriver=pt,e.ɵsupportsWebAnimations=function yt(){return"function"==typeof ft()},e.ɵWebAnimationsPlayer=ht,e.ɵallowPreviousPlayerStylesMerge=Y,Object.defineProperty(e,"__esModule",{value:!0})});