 ...
 * License: MIT
 */
!function(global,factory){"object"==typeof exports&&"undefined"!=typeof module?factory(exports):"function"==typeof define&&define.amd?define(["exports"],factory):factory((global.ng=global.ng||{},global.ng.animations=global.ng.animations||{}))}(this,function(exports){"use strict";function trigger(name,definitions){return{type:0,name:name,definitions:definitions}}function animate(timings,styles){return{type:5,styles:styles,timings:timings}}function group(steps,locals){return{type:4,steps:steps,locals:locals}}function sequence(steps,locals){return{type:3,steps:steps,locals:locals}}function style(tokens){return{type:7,styles:tokens}}function state(name,styles){return{type:1,name:name,styles:styles}}function keyframes(steps){return{type:6,steps:steps}}function transition(stateChangeExpr,steps,locals){return{type:2,expr:stateChangeExpr,animation:steps,locals:locals}}function animation(steps,locals){return{type:8,animation:steps,locals:locals}}function animateChild(){for(var args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];return{type:9,args:args}}function query(selector,animation,locals){return{type:10,multi:!1,selector:selector,animation:animation,locals:locals}}function queryAll(selector,animation,locals){return{type:10,multi:!0,selector:selector,animation:animation,locals:locals}}function stagger(){for(var args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];return{type:11,args:args}}/**
 * @license
