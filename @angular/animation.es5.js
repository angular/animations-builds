...
DomAnimationTransitionEngine.decorators = [{ type: Injectable }];
/** @nocollapse */
...
AnimationModule.decorators = [{ type: NgModule, args: [{
        providers: [{ provide: AnimationDriver, useFactory: resolveDefaultAnimationDriver }, { provide: AnimationStyleNormalizer, useClass: WebAnimationsStyleNormalizer }, { provide: ɵTransitionEngine, useClass: DomAnimationTransitionEngine }]
    }] }];
/** @nocollapse */
...
var Animation = function () {
    ...
    _createClass(Animation, [{
        ...
        value: function buildTimelines(startingStyles, destinationStyles) {
            var /** @type {?} */start = Array.isArray(startingStyles) ? normalizeStyles(new AnimationStyles( /** @type {?} */startingStyles)) : startingStyles;
            var /** @type {?} */dest = Array.isArray(destinationStyles) ? normalizeStyles(new AnimationStyles( /** @type {?} */destinationStyles)) : destinationStyles;
